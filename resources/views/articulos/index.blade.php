...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item active" aria-current="page"><span>Artículos</span></li>
@endsection
                    ...
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="row">
                                ...
                                <div class="col">
                                    <a href="{{route('articulos.create')}}" class="btn btn-primary mb-2 float-right">Registrar</a>
                                </div>
                            </div>
                                ...
                                <table id="zero-config" class="table table-hover" style="width:100%; text-align: center;">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td style="font-size: 18px;">{{$key->categoria->nombre}}</td>
                                            <td style="font-size: 18px;">{{$key->nombre}}</td>

                                            <td style="font-size: 18px;">{{$key->codigo}}</td>
                                            <td style="font-size: 18px;">{{$key->stock}}</td>
                                            <td>

                                                <a href="{{route('articulos.edit',$key->id)}}" 
                                                class="bs-tooltip" 
                                                ...
                                                <a href="javascript:eliminar('{{route('articulos.destroy',$key->id)}}','{{$key->nombre}}')"
                                                    class="bs-tooltip" 
...
@section('script')
    ...
    <script type="text/javascript">
        function eliminar (link,name){
            swal({   
                title: "¿Estás seguro?",
                text: "¿Deseas eliminar el artículo: "+name+"  ?",
                type: "warning",
                ...
                if (isConfirm) {
                    ...
                    swal("Cancelado", "Tu artículo "+name+" no fue eliminado", "error");
                }
            });
        }
    </script>
