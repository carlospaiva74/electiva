...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item active" aria-current="page"><span>Usuario</span></li>
@endsection
                    ...
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="row">
                                ...
                                <div class="col">
                                    <a href="{{route('usuarios.create')}}" class="btn btn-primary mb-2 float-right">Registrar</a>
                                </div>
                            </div>
                                ...
                                <table id="zero-config" class="table table-hover" style="width:100%; text-align: center;">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td style="font-size: 18px;">{{$key->persona->nombre}}</td>
                                            <td style="font-size: 18px;">{{$key->persona->email}}</td>
                                            <td style="font-size: 18px;">{{$key->rol->nombre}}</td>
                                            <td>
                                                ...
                                                <a href="javascript:eliminar('{{route('usuarios.destroy',$key->id)}}','{{$key->persona->nombre}}')"
                                                    class="bs-tooltip" 
...
@section('script')
    ...
    <script type="text/javascript">
        function eliminar (link,name){
            swal({   
                title: "¿Estás seguro?",
                text: "¿Deseas eliminar al usuario : "+name+"  ?",
                type: "warning",
                ...
                if (isConfirm) {
                    ...
                    swal("Cancelado", "El usuario "+name+" no fue eliminado", "error");
                }
            });
        }
    </script>
